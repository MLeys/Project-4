...
export function CaretUpIcon({color= "currentColor", fill="currentColor", height=16, width=16}) {
  return (
    <svg 
    color={color}
    xmlns="http://www.w3.org/2000/svg" 
...
export function CaretDownIcon({color= "currentColor", fill="currentColor", height=16, width=16}) {
  return (
    <svg 
    color={color}
    xmlns="http://www.w3.org/2000/svg" 
...
export function ArrowLeftIcon({color= "currentColor", fill="currentColor", height=16, width=16}) {
  return (
    <svg 
    color={color}
    xmlns="http://www.w3.org/2000/svg" 
